...
client.on('guildMemberAdd', async member => {
	...
	if (guild != member.guild) {
		...
		let embed = await new Discord.MessageEmbed()
			.setColor('#7c2ae8')
			.setAuthor(member.user.tag, member.user.displayAvatarURL())
			.setTitle(`<:w_sangue:921211855316348958>  𝐁𝐄𝐌 𝐕𝐈𝐍𝐃𝐎 𝐀𝐎 𝐈𝐍𝐅𝐄𝐑𝐍𝐎 <:w_sangue:921211855316348958>`)
			.setImage('https://i.imgur.com/LQgyoZM.jpeg')
...
client.on("guildCreate", (guild) => {
    ...
    Prazer sou o <a:coroa:898814229640019968> Gizmo para ver minha central de ajuda digite **[g!ajuda ou g!help] **`);
})
